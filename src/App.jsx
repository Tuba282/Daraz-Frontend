...
const NotFound = () => <div className="p-8 text-center"><h1 className="text-4xl font-bold">404</h1><p>Page Not Found</p></div>;
    ...
    <Routes>
      ...
      <Route element={<RoleRoute allowedRoles={['customer']} />}>
        <Route element={<CustomerLayout />}>
          ...
          <Route path="/profile/addresses" element={<div className="p-6 text-gray-500">Address Book (Coming Soon)</div>} />
          <Route path="/profile/payment-options" element={<div className="p-6 text-gray-500">Payment Options (Coming Soon)</div>} />
          <Route path="/profile/wallet" element={<div className="p-6 text-gray-500">Daraz Wallet (Coming Soon)</div>} />
          <Route path="/profile/returns" element={<div className="p-6 text-gray-500">My Returns (Coming Soon)</div>} />
          <Route path="/profile/cancellations" element={<div className="p-6 text-gray-500">My Cancellations (Coming Soon)</div>} />
          <Route path="/profile/reviews" element={<div className="p-6 text-gray-500">My Reviews (Coming Soon)</div>} />
        </Route>
      </Route>
