...
import { FiHome, FiBox, FiShoppingBag, FiSettings, FiLogOut, FiMenu } from 'react-icons/fi';
...
const VendorLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      ...
      >
        <div className="h-16 flex items-center justify-center border-b border-gray-700 bg-primary">
          <h2 className="text-xl font-bold tracking-wider">Vendor Panel</h2>
        </div>
