      ...
      <div className="bg-primary text-white text-xs px-4 hidden md:block">
        <div className="container mx-auto flex justify-end items-center h-[30px]">
          <div className="flex space-x-4 uppercase items-center h-full">
            ...
            <div className="relative h-full flex items-center">
              ...
              {activeDropdown === 'app' && (
                <div className="absolute top-full -left-4 w-[280px] bg-white rounded-sm shadow-xl p-4 z-100 text-black border border-gray-100">
                  ...
                  <h3 className="text-sm font-semibold mb-3 capitalize text-gray-800">Download the App</h3>
                  <div className="flex gap-4 items-center">
                    <div className="w-[100px] h-[100px] border border-gray-200 p-1 rounded-sm">
                      <img src="/others/daraz-qr.png" alt="QR Code" className="w-full h-full object-contain" />
                    </div>
                    <div className="flex flex-col gap-2 flex-1">
                      <div className="bg-black rounded-md overflow-hidden">
                        <img src="/footer/appstrore.png" alt="App Store" className="w-full object-contain h-8" />
                      </div>
                      <div className="bg-black rounded-md overflow-hidden">
                        <img src="/footer/googleplay.png" alt="Google Play" className="w-full object-contain h-8" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Link to="/sell" className="hover:text-gray-200 cursor-pointer transition-colors">Sell On Daraz</Link>
              ...
              {activeDropdown === 'help' && (
                <div className="absolute top-full -left-4 w-[250px] bg-white rounded-sm shadow-xl z-100 text-black border border-gray-100 pb-2">
                  ...
                  <div className="flex flex-col gap-2 mt-2">
                    <Link to="/help-center" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiHelpCircle className="text-lg text-gray-500" /> Help Center
                    </Link>
                    <Link to="/contact" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiMessageSquare className="text-lg text-gray-500" /> Contact Customer Care
                    </Link>
                    <Link to="/order" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-3 py-3 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiPackage className="text-lg text-gray-500" /> Order
                    </Link>
                    <Link to="/shipping" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiTruck className="text-lg text-gray-500" /> Shipping & Delivery
                    </Link>
                    <Link to="/payment" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiCreditCard className="text-lg text-gray-500" /> Payment
                    </Link>
                    <Link to="/returns" onClick={() => setActiveDropdown(null)} className="flex items-center gap-3 px-4 py-4 hover:bg-gray-50 hover:text-primary transition-colors text-[13px] capitalize font-medium text-gray-600">
                      <FiRefreshCcw className="text-lg text-gray-500" /> Returns & Refunds
                    </Link>
                  </div>
                </div>
              )}
            ...
            <div className="relative h-full flex items-center">
              ...
              {activeDropdown === 'lang' && (
                <div className="absolute top-full right-0 w-[180px] bg-white rounded-sm shadow-xl z-100 text-black border border-gray-100 py-2">
                  <div className="absolute -top-1.5 right-4 w-3 h-3 bg-white transform rotate-45 border-l border-t border-gray-100"></div>
                  <div className="flex flex-col">
                    <button onClick={() => setActiveDropdown(null)} className="flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center gap-3">
                        <img src="/others/urdu.png" alt="PK" className="w-7 h-7 rounded-full object-cover" style={{ aspectRatio: '1/1' }} />
                        <span className="text-[12px] font-medium text-gray-600">UR / Urdu</span>
                      </div>
                    </button>
                    <button onClick={() => setActiveDropdown(null)} className="flex items-center justify-between px-4 py-2 hover:bg-gray-50 transition-colors bg-gray-50">
                      <div className="flex items-center gap-3">
                        <img src="/others/english.png" alt="EN" className="w-7 h-7 rounded-full object-cover" style={{ aspectRatio: '1/1' }} />
                        <span className="text-[12px] font-medium text-gray-600">EN / English</span>
                      </div>
      ...
      <div className="bg-primary text-white shadow-md py-4 px-4 relative z-50">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-4 justify-start">
          ...
          <div className="hidden md:flex items-center space-x-6">
            {/* Cart Link */}
            <Link to="/cart" className="relative flex items-center gap-1.5 hover:text-secondary group transition-colors">
              ...
              <div className="relative">
                ...
                {showUserDropdown && (
                  <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-lg shadow-dropdown border border-gray-100 py-2 text-gray-800 animate-slide-down z-50">
                    ...
                    {user?.role === 'admin' && (
                      <Link to="/admin" className="flex items-center gap-2.5 px-4 py-2.5 hover:bg-gray-50 text-sm font-medium transition-colors text-gray-700">
                        <FiGrid className="text-primary" /> Admin Portal
                      </Link>
                    )}
                    {user?.role === 'vendor' && (
                      <Link to="/vendor" className="flex items-center gap-2.5 px-4 py-2.5 hover:bg-gray-50 text-sm font-medium transition-colors text-gray-700">
                        <FiGrid className="text-primary" /> Vendor Dashboard
                      </Link>
                    )}
                    {user?.role === 'customer' && (
                      <Link to="/profile" className="flex items-center gap-2.5 px-4 py-2.5 hover:bg-gray-50 text-sm font-medium transition-colors text-gray-700">
